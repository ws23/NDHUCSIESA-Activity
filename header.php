...
<p align="center" style="position: absolute; top: 0px; left: 50%;margin-left: -230px;"><input type="button" style="border: 0px; background-color: transparent; color: transparent; font-size: 110pt; font-family: 微軟正黑體;" value="資工系" onclick="window.location.href='index.php';"></p>
